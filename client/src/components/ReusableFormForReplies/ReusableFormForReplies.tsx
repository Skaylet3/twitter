...
const ReusableFormForReplies = ({ placeholder ,buttonText, image, onCreate, onImageChange, ref }) => {
    //reply text context
    ...
    //content checker
    useEffect(() => {
        console.log("text of the reply context is: ", replyText);
    }, [replyText]);
...
export default ReusableFormForReplies