  ...
  return (
      <>
        <Routes location={state?.backgroundLocation || location} >
          <Route path="/" element={<ApiProvider><ProfileAvatarProvider><FeedProvider><Home /></FeedProvider></ProfileAvatarProvider></ApiProvider>} />
          <Route path="/home" element={<ApiProvider><FeedProvider><Home /></FeedProvider></ApiProvider>} />
          <Route path="/register" element={<Register />} />
          <Route path="/Login" element={<Login />} />
          <Route path="/:username/status/:tweetId" element={<ApiProvider><TweetCard /></ApiProvider>} />
          <Route path="/compose/post/:replyTo" element={<ApiProvider><ModalReply /></ApiProvider>} />
          <Route path="/settings/profile" element={<ApiProvider><EditProfileModal /></ApiProvider>} />
          <Route path="/profile" element={<ApiProvider><ProfileFeedProvider><Profile /></ProfileFeedProvider></ApiProvider>} /> 
          <Route path="/settings" element={<ApiProvider><Settings /></ApiProvider>}>
            <Route path='account' element={<ApiProvider><YourAccountOptions /></ApiProvider>} />
            <Route path='deactivate' element={<ApiProvider><DeactivateAccount /></ApiProvider>} />
          </Route>
        </Routes>
